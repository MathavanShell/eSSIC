...
namespace eSSIC {
    ...
    public partial class CalcService : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(CalcService).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(CalcService));
        ...
        private string FindResource() {
            string[] resources = typeof(CalcService).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".CalcService.g.xaml") || resource.Equals("CalcService.g.xaml"))) {
                    return resource;
                }
            }
